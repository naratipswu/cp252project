...
## สรุปการประชุม
* ความคืบหน้าการพัฒนาระบบ Phase 1-2 และเป้าหมายโครงการ
* การพัฒนาเชิงเทคนิคที่เพิ่มเติมจากแผนเดิม (Extra Developments)
* ปรับโครงสร้างฐานข้อมูล: เปลี่ยนมาใช้ PostgreSQL เป็นฐานข้อมูลหลัก เพื่อรองรับความสัมพันธ์ของข้อมูลที่ซับซ้อนได้อย่างมีประสิทธิภาพมากขึ้น
* เพิ่มการทดสอบระบบอัตโนมัติ: นำ Jest มาใช้สำหรับทำ Unit Testing เพื่อการันตีความถูกต้องของ Logic การคำนวณและสถานะการทำงานต่างๆ
* เพิ่มระบบจัดการโปรโมชั่น: พัฒนาฟีเจอร์ส่วนลดเพิ่มเข้ามา เพื่อให้ Admin มีเครื่องมือกระตุ้นยอดเช่าและสามารถจัดการโปรโมชั่นได้อย่างคล่องตัว
* เชื่อมโยง Workflow แบบไร้รอยต่อ: ปรับปรุง Flow การทำงานตั้งแต่ขั้นตอน การจอง (Booking) > ชำระเงิน (Payment) > รับของ (Order) ให้เชื่อมต่อกันอย่างสมบูรณ์แบบ

## Retrospective Video
* **YouTube link:** [retropective video](https://youtu.be/ZxtAb00LJ-A?si=j34mKsUIfO1eeebz)
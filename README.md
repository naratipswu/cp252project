...
Stock Management
Admin สามารถ เพิ่ม/ลบ/แก้ไข ข้อมูลกล้องและอุปกรณ์ (CRUD Operations)
Admin สามารถกำหนดสถานะของอุปกรณ์ได้ 
Order Management
Admin สามารถตรวจสอบสลิปการโอนเงินและกด อนุมัติ หรือ ปฏิเสธ การจองได้
Admin สามารถอัปเดตสถานะเมื่อมีการรับของและคืนของ 
ระบบต้องมีการคำนวณค่าปรับ กรณีคืนล่าช้ากว่ากำหนด 
Dashboard & Report
แสดงภาพรวมรายการที่ต้องส่งมอบและรับคืนในแต่ละวัน
แสดงรายงานสรุปรายได้ ประจำเดือน
...
ผู้รับผิดชอบ: วัชรพงศ์ มาลัง  ดูแลข้อมูลกล้องและอุปกรณ์ในร้าน
Method: findCamerasByBrand ใช้ค้นหากล้องตามยี่ห้อ เวลาลูกค้าถามว่ามีกล้องยี่ห้อที่ต้องการหรือไม่


Method: calculateAverageDailyPrice ใช้คำนวณราคาเช่าเฉลี่ย เพื่อดูว่าราคาที่ตั้งไว้เหมาะสมหรือไม่



2. Class: BookingQueue (จัดการคิวจอง)
ผู้รับผิดชอบ: นราธิป สุวณิชย์ ดูแลคิวการจองและยอดค่าเช่า
Method: findBookingByCustomerName ใช้ค้นหาการจองจากชื่อลูกค้า เพื่อตรวจสอบสถานะ


Method: getHighestValueBooking ใช้หาการจองที่มียอดเงินสูงที่สุด เพื่อดูแลลูกค้าคนสำคัญ



3. Class: UserRegistry (ทะเบียนสมาชิก)
ผู้รับผิดชอบ: ปกรณ์เกียรติ จิมแสง ดูแลข้อมูลสมาชิกและประวัติการเช่า
Method: countUsersByMembership ใช้นับจำนวนสมาชิกแต่ละประเภท


Method: findUserWithLeastRentals ใช้หาลูกค้าที่มาเช่าน้อยที่สุด เพื่อนำไปทำโปรโมชั่น
